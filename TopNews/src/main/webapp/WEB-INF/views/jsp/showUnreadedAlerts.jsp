...
<html>
<head>
<title><spring:message code="unreadedAlerts" text="Unreaded Alerts" /></title>
...
<body>
	...
	<div class="single_sidebar">
		<h2>
			<span><spring:message code="unreadedAlerts" text="Unreaded Alerts" /></span>
		</h2>
					...
					<c:when test="${not empty alerts}">
						<ul>
							<c:forEach var="email" items="${alerts}">
								...
								<h3>
									<a href="./Alerts?id=${email.id}">${email.subject}</a>
								</h3>
								<h5>
